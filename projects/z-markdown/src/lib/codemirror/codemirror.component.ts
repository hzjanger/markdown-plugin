import {
  ...
  EventEmitter,
  forwardRef,
  Input, KeyValueDiffer, KeyValueDiffers, NgZone,
  OnDestroy,
  OnInit,
  Output, ViewChild
} from '@angular/core';
...
export class CodemirrorComponent implements OnInit, AfterViewInit, OnDestroy, ControlValueAccessor, DoCheck {
